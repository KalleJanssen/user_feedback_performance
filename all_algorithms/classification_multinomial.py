...
file.write("classification, multinomial, " + start[:-3] + ", " + end[:-3] + "\n")
file.close()
...
if not os.path.exists(filename):
    ...
    file.write("classification, multinomial, " + str(correct/(correct+incorrect)) + ", " + str(precision) + ", " + str(recall) + ", " + str(F1) + "\n")
else:
    file = open(filename,"a")
    file.write("classification, multinomial, " + str(correct/(correct+incorrect)) + ", " + str(precision) + ", " + str(recall) + ", " + str(F1) + "\n")
