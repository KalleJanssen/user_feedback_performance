...
file.write("classification_three, forest, " + start[:-3] + ", " + end[:-3] + "\n")
file.close()
...
if not os.path.exists(filename):
    ...
    file.write("classification_three, forest, " + str(correct/(correct+incorrect)) + ", " + str(precision) + ", " + str(recall) + ", " + str(F1) + ", 0\n")
else:
    file = open(filename,"a")
    file.write("classification_three, forest, " + str(correct/(correct+incorrect)) + ", " + str(precision) + ", " + str(recall) + ", " + str(F1) + ", 0\n")
